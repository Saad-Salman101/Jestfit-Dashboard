...
import { registerUserAsVendor } from 'store/reducers/userReducer';

// ===========================|| FIREBASE - REGISTER ||=========================== //

const VendorRegistrationForm = ({ ...others }) => {
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          companyName: Yup.string().required("Please enter Companies Name"),
          slogan: Yup.string().required("Please enter slogan"),
          description: Yup.string().required("Please enter description"),
          companyPhoneNumber: Yup.string().required("Please enter company phone number")
        ...
        onSubmit={async(values, { setSubmitting }) => {
          setSubmitting(true)
          dispatch(registerUserAsVendor(values))
          ...
          <form noValidate onSubmit={handleSubmit} {...others}>
            <Grid container spacing={matchDownSM ? 0 : 2}>
              <Grid item xs={12} sm={6}>
                ...
                />
                {errors.firstName && touched.firstName ? <FormHelperText error>{errors.phoneNumber}</FormHelperText>:null}
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  sx={{ ...theme.typography.customInput }}
                />
                 {errors.lastName && touched.lastName ? <FormHelperText error>{errors.lastName}</FormHelperText>:null}
              </Grid>
            </Grid>
      ...
      <FormControl fullWidth error={Boolean(touched.companyName && errors.companyName)} sx={{ ...theme.typography.customInput }}>
            ...
            <FormControl fullWidth error={Boolean(touched.slogan && errors.slogan)} sx={{ ...theme.typography.customInput }}>
              <InputLabel htmlFor="outlined-adornment-slogan-register">Companies'slogan</InputLabel>
              <OutlinedInput
                id="outlined-adornment-slogan-register"
                type="string"
                value={values.slogan}
                name="slogan"
                onBlur={handleBlur}
            ...
            <FormControl fullWidth error={Boolean(touched.description && errors.description)} sx={{ ...theme.typography.customInput }}>
              <InputLabel htmlFor="outlined-adornment-description-register">Company's Description</InputLabel>
              <OutlinedInput
            ...
            <FormControl fullWidth error={Boolean(touched.companyPhoneNumber && errors.companyPhoneNumber)} sx={{ ...theme.typography.customInput }}>
              <InputLabel htmlFor="outlined-adornment-companyPhoneNumber-register">Company's Contact Number</InputLabel>
              <OutlinedInput
                id="outlined-adornment-companyPhoneNumber-register"
