        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Situated In</TableCell>
          ...
          <TableBody>
            {data?.map((row, index) => (
              <TableRow key={row.index}>
                ...
                <TableCell>{row?.sportTypeID?.name}</TableCell>
                <TableCell>{row?.locationID?.name}</TableCell>
                {/* <TableCell>
                  {row?.slots?.map((field, index) => (
                    <span key={index}>
                ...
                <TableCell>
                  <IconEdit
                    onClick={() =>
                      navigate(`/updateField?fieldID=${row?.id}`, {
                        state: { id: row?.id },
                      })
                    }
                  />
